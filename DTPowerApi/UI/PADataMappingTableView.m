...
#import "PADataMappingTableView.h"
#import "CustomRowView.h"
#import "Global.h"

@implementation PADataMappingTableView
@synthesize colors;
...
//    [super drawBackgroundInClipRect:clipRect];
    ...
    while (yStart < NSMaxY(clipRect)+self.rowHeight)
    {
        ...
        NSRect rowFrame = NSMakeRect(0, yRowTop, clipRect.size.width + 1000, self.rowHeight);
...
//        NSRectFill(rowFrame);
        ...
        [bg drawInRect:rowFrame fromRect:NSZeroRect operation:NSCompositeSourceOver fraction:1.0];
